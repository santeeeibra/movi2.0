...
map.on('load', () => {
  ...
  map.loadImage('/icons/auto-top.png', (error, image) => {
    ...
    // Sombra proyectada debajo del auto: sin esto el icono top-down se ve
    // "pegado" al mapa, sin volumen. Un blob suave semitransparente alcanza
    // para dar sensacion de que el auto flota levemente sobre la calle.
    map.addLayer({
